...
public class CaffeineCacheConfig {
    ...
    public CacheManager cacheManager() {
        ...
        CaffeineCacheManager cacheManager = new CaffeineCacheManager(CaffeineCacheConstants.CACHE_NAME);
    ...
    static class CustomRemovalListener implements RemovalListener<Object, Object> {
        ...
        public void onRemoval(Object key, Object value, RemovalCause cause) {
            log.info("removal listener called with key [%s], cause [%s], evicted [%S]\n",
                    key,
                    cause.toString(),
                    cause.wasEvicted());
        }
